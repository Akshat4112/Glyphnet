...
class NeuralNetwork:
  ...
  def SimpleCNN(self):
    ...
    self.history = model.fit(self.train_it,validation_data=self.validation_it, steps_per_epoch=500, epochs=30, verbose=1, callbacks=[WandbCallback()])
  ...
  def AttentionCNN(self):
    ...
    self.history = model.fit(self.train_it,validation_data=self.validation_it, steps_per_epoch=500, epochs=5, verbose=1, callbacks=[WandbCallback()])
  ...
  def plotGraphs(self):
    ...
    acc_fig_name = '../figures/' + '_acc_' + self.name
    ...
    plt.xlabel('epoch')
    plt.legend(['train', 'val'], loc='upper left')
    loss_fig_name = acc_fig_name = '../figures/' + '_loss_' + self.name
