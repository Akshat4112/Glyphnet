...
with open("domains_final.txt", "r") as f:
    domains_1 = f.read().splitlines()[:400000]

with open("domains_final.txt", "r") as f:
	domains_2 = f.read().splitlines()[400000:800000]


homo = []

def multiprocessing_func_1(domain):
  homo_1.append(homo_gen_1(domain))

def multiprocessing_func_2(domain):
...
if __name__ == "__main__":
	...
	with Manager() as manager:
		...
		processes_2 = []
		for i in domains_1:
			p = multiprocessing.Process(target=multiprocessing_func_1, args=(i,))
		...
		for i in domains_2:
			p = multiprocessing.Process(target=multiprocessing_func_2, args=(i,))
		...
		dataf.to_csv('dataset.csv', index = False)
